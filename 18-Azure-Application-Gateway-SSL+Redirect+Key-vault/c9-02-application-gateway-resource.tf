...
locals {
  ...
  # App1
  backend_address_pool_name_app1 = "${azurerm_virtual_network.vnet.name}-backend-pool-app1"
  http_setting_name_app1         = "${azurerm_virtual_network.vnet.name}-be-http-stngs-app1"
