  ...
  profile {
    ...
    rule {
      ...
      metric_trigger {
        ...
        time_aggregation   = "Average"
        operator           = "LessThan"
        threshold          = 73741824 #1073741824 # Increase 1 VM when Memory In Bytes is less than 1GB
      }
    }
    ...
    rule {
      ...
      metric_trigger {
        ...
        time_aggregation   = "Average"
        operator           = "GreaterThan"
        threshold          = 247483648 # Decrease 1 VM when Memory In Bytes is Greater than 2GB
      }
    }
